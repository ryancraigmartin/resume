...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/ryancraigmartin/resume)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>an array of objects for each social profile you want to link; each object should include a <code>name</code> (e.g. "Github"), <code>user</code> (e.g. "@;ryancraigmartin") and <code>url</code> (e.g. "https://github.com/ryancraigmartin") property</td>
            <td>optional</td>
        </tr>
    </tbody>
</table>
...
* "Butler" headline font by [Fabian de Smet](https://fabiandesmet.com/portfolio/butler-font/) (CC BY-SA 4.0 [License](https://github.com/ryancraigmartin/resume/tree/master/src/assets/fonts/Butler_ButlerStencil_FontLicense_v1_0.pdf))
